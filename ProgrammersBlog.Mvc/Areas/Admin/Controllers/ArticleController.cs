...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        public async Task<IActionResult> Update(int articleId)
        {
            ...
            {
                var aritcleUpdateViewModel = Mapper.Map<ArticleUpdateViewModel>(articleResult.Data);
                aritcleUpdateViewModel.Categories = categoriesResult.Data.Categories;
                return View(aritcleUpdateViewModel);
            }
            else
            {
                return NotFound();
        ...
        public async Task<IActionResult> Update(ArticleUpdateViewModel articleUpdateViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var uploadedImageResult = await ImageHelper.Upload(articleUpdateViewModel.Title, articleUpdateViewModel.ThumbnailFile,
                        PictureType.Post);
                    articleUpdateViewModel.Thumbnail = uploadedImageResult.ResultStatus == ResultStatus.Success ?
                        uploadedImageResult.Data.FullName : "postImages/defaultThumbnail.jpg";
        ...
        public async Task<JsonResult> Delete(int articleId)
        {
            ...
            var articleResult = System.Text.Json.JsonSerializer.Serialize(result);
        ...
        {
            var result = await _articleService.GetAllByDeletedAsync();
            var articles = System.Text.Json.JsonSerializer.Serialize(result, new JsonSerializerOptions
            {
                ReferenceHandler = ReferenceHandler.Preserve
            });
